...
export const LeafIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M11 20A7 7 0 0 1 4 13V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><path d="M15.5 5.5A2.5 2.5 0 0 1 18 8V11a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V8a2.5 2.5 0 0 1 2.5-2.5z"></path>
    </svg>
);
...
export const AiChatbotIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 6V4H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-2"></path><path d="M2 12h10"></path><path d="m9 9 3 3-3 3"></path><path d="M22 12h-2"></path><path d="M17 17v-2a2 2 0 0 0-2-2h-1v-2a2 2 0 0 0-2-2H8"></path>
    </svg>
);
...
export const FlaskConicalIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M10 2v7.31"></path><path d="M14 9.31V2"></path><path d="M8.5 2h7"></path><path d="M14 9.31 16.5 14"></path><path d="M10 9.31 7.5 14"></path><path d="M6.18 15.44 4 22h16l-2.18-6.56"></path>
    </svg>
);
...
export const CloudSunIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 16a4 4 0 1 0-8 0"></path>
        <path d="M12 2v2"></path>
        <path d="m4.93 4.93 1.41 1.41"></path>
        <path d="M20 12h2"></path>
        <path d="m17.66 17.66 1.41 1.41"></path>
...
export const DropletsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.7-3.29C8.2 7.95 7 6.46 7 4.55V4c0-.55.45-1 1-1h.5c.28 0 .5.22.5.5v.55c0 2.39 1.62 4.14 3.5 4.4V8.5c0-.28.22-.5.5-.5h.5c.55 0 1 .45 1 1v1.05c0 1.9.9 3.4 2.3 4.29 1.2 1.03 1.7 2.13 1.7 3.29 0 2.22-1.8 4.05-4 4.05h-7Z"></path>
    </svg>
);
